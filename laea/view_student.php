...
<body>
    ...
    <div class="modal fade" id="newTaskModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-content">
                <center>
                    <div class="modal-header">
                        <h5 class="modal-title" id="newTaskModalLabel">Create a New Task for Student -
                            <?php echo $_SESSION['student_id'] ?></h5>
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-lg-8 " data-aos="zoom-in">
                                    <div>
                                        ...
                                        <div class="question_div mt-3">
                                            ...
                                            <input type='file' class='form-control' id='new_task_pdf'
                                                name='Task_pdf_file' onchange="uploadFile()" />
                                ...
                                <div class="col-lg-4" data-aos="fade-left">
                                    <div class="portfolio-info">
                                        <h3>DETAILS</h3>
                                        <ul>
                                            <li><strong>Due</strong>: <input type='datetime-local' class='form-control'
                                                    name='Due_Timestamp' /></li>
                                            <li><strong>Marks Possible</strong><input type='number' class='form-control'
                                                    name='Marks_possible' /></li>
                                        </ul>
                                    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="taskViewModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="taskViewModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
