    ...
    <main id="main">
        ...
        <table>
            ...
            <tr>
                <section class="inner-page">
                    <center>
                        <h4>Add a new task for all students</h4>
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-lg-4" data-aos="fade-left">
                                        <div class="portfolio-info">
                                            <h3>DETAILS</h3>
                                            <ul>
                                                <li><strong>Due</strong>: <input type='datetime-local'
                                                        class='form-control' name='Due_Timestamp' /></li>
                                                <li><strong>Marks Possible</strong><input type='number'
                                                        class='form-control' name='Marks_possible' /></li>
                                            </ul>
                                        </div>
